...
console.log(filteredMovies.data.length)
...
return (
    ...
    }): loader||filteredMovies?.data.length>0? "": <h2 className='noData'>No movies found</h2>
    }
    {
        !loader&&(filteredMovies?.data.length)===0&&(
           (<h2 className='noData'>No TvShows in this genre</h2>)
        )
    }
